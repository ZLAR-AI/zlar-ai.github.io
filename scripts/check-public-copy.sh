...
assert_contains_fixed \
    ...
    "proof-pack.html" \
    "The current release adds read-only installed-runtime-profile selector preflight evidence"

assert_contains_fixed \
    "website README keeps current release pointer" \
    "README.md" \
    "ZLAR v3.4.5 - Installed runtime-profile selector preflight"

assert_contains_fixed \
    "LLM index keeps current release pointer" \
    "llms.txt" \
    "Current public release: ZLAR v3.4.5 - Installed runtime-profile selector preflight."
...
assert_contains_fixed \
    ...
    "caisi-submission.html" \
    "Current ZLAR public claims are bounded by v3.4.5"
