...
assert_contains_fixed \
    ...
    "proof-pack.html" \
    "The current release adds read-only installed-runtime-profile recognition-contract evidence"
...
assert_contains_fixed \
    ...
    "llms.txt" \
    "Current public release: ZLAR v3.4.6 - Installed runtime-profile recognition contract."
...
assert_contains_fixed \
    ...
    "caisi-submission.html" \
    "Current ZLAR public claims are bounded by v3.4.6"
...
assert_contains_fixed \
    ...
    "boundaries.html" \
    "The current v3.4.6 release publishes all required verifier-kit assets"
